...
if __name__ == '__main__':
    ...
    print('Address of biggest bar:', get_address_of_biggest_bar(data))
    print('Address of smallest bar:', get_address_of_smallest_bar(data))
    latitude = float(input('Input latitude >> '))
    longitude = float(input('Input longitude >> '))
    print('Address of closest bar:', get_address_of_closest_bar(data, longitude, latitude))
